...
public class Hippo_move : MonoBehaviour 
{
	public float speed;
	...
	{
		progressPoints = 0;
		Debug.Log("before rigid body");
		rb2d = GetComponent<Rigidbody2D> ();
		Debug.Log("after rigid body");
		rb2d.transform.position = new Vector2 (0f, -4.19f); 
	...
	void FixedUpdate () 
	{
		...
		rb2d.transform.position = new Vector2 (Mathf.Clamp (rb2d.transform.position.x, (-horzExtent + (0.6f * rb2dMidToEdge)), (horzExtent - rb2dMidToEdge)), rb2d.transform.position.y);
